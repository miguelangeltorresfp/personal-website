...
const moment = __webpack_require__(239);
...
exports.handler = function (event, context, callback) {
    let getGithubData = (() => {
        var _ref = _asyncToGenerator(function* () {
            try {
                let totalCommits = 0;
                let repositories = yield githubRecentRepos;
                let count = repositories.length;
                for (let i = 0; i < repositories.length; i++) {
                    let repositoryName = repositories[i];
                    let commits = yield githubCommits(repositoryName);
                    count--;
...
var moment = module.exports = __webpack_require__(240);
moment.tz.load(__webpack_require__(243));
